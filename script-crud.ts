...
let tareaSeleccionada: null | Tarea = null
let liTareaSeleccionada: null | HTMLLIElement = null
console.log(tareas)
...
function crearElementoTarea(tarea: Tarea) {
...
const eliminarTareas = (soloConcluidas: boolean) => {
